...
-- Run: psql $DATABASE_URL -f migrations/versions/003_phase1_rag_manifest_sales_gates.sql

BEGIN;

-- ============================================================
-- Step 1: Create shared ENUM types
-- ============================================================
DO $$
BEGIN
...
-- (must come after both knowledge_chunks + sessions exist)
-- ============================================================
