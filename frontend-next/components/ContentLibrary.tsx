  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 w-full min-h-0">
      ...
      <div className="flex-1 bg-[#1c2026] rounded-lg overflow-hidden flex flex-col md:flex-row">
        {/* Category tabs */}
        <div className="flex md:flex-col gap-0 border-b md:border-b-0 md:border-r border-white/[0.06] min-w-0 md:min-w-[180px] overflow-x-auto md:overflow-x-visible">
