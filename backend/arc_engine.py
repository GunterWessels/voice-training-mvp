...
class ArcStageTracker:
    def __init__(self, arc: Dict[str, Any]):
        ...
        self.spin_flags: Dict[str, bool] = {
            "situation": False, "problem": False, "implication": False, "need_payoff": False
        }
        self.challenger_flags: Dict[str, bool] = {
            "teach": False, "tailor": False, "take_control": False
        }
    ...
    def _update_flags(self, history: List[Dict]):
        ev = self.evaluator
    ...
    # Keep legacy name working — some callers use _update_cof_flags
